...
?>
<section class="splash--<?php if ( is_page()): global $post; if ( isset( $post ) ): echo $post->post_name; endif; endif; ?> <?php // if ( is_front_page() ): echo 'splash--nomargin'; endif; ?> pageblock">
